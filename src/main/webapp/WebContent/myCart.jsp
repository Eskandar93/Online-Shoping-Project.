...
<% if("decrement".equals(msg)){%>
<h3 class="alert">Quantity  Dereased Successfully!</h3>
<%} %>
      ...
      %>
          ...
          <%sno +=1; %>
           <td><%out.println(sno); %></td>
            ...
            <td><a href="inDecQuantityAction.jsp?id=<%=rs.getString(1)%>&quantity=inc"><i class='fas fa-plus-circle'></i></a> <%=rs.getInt(8) %> <a href="inDecQuantityAction.jsp?id=<%=rs.getString(1)%>&quantity=dec"><i class='fas fa-minus-circle'></i></a></td>
            <td><i class="fa fa-inr"></i> <%=rs.getDouble(10) %></td>
